...
namespace IncludedAssets {
    ...
    */
    namespace __AssetExterns__ {
        extern "C" uint8_t _binary_ModList_frame_png_start[];
        extern "C" uint8_t _binary_ModList_frame_png_end[];
        extern "C" uint8_t _binary_ModList_frame_png_size[];
    }  // namespace __AssetExterns__

    namespace ModList {
        /**
         * Binary asset representing the file "ModList/frame.png".
         * Embedded with love (and a little objcopy magic), mmkay?
         */
        const IncludedAsset frame_png {
            ::IncludedAssets::__AssetExterns__::_binary_ModList_frame_png_start,
            ::IncludedAssets::__AssetExterns__::_binary_ModList_frame_png_end
        };
    }  // namespace ModList
}  // namespace IncludedAssets
